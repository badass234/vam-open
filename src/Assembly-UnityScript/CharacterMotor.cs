...
public class CharacterMotor : MonoBehaviour
{
	...
	internal sealed class _0024SubtractNewPlatformVelocity_00241 : GenericGenerator<object>
	{
		...
		{
			internal Transform _0024platform_00242;

			internal CharacterMotor _0024self__00243;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					if (_0024self__00243.movingPlatform.enabled && (_0024self__00243.movingPlatform.movementTransfer == MovementTransferOnJump.InitTransfer || _0024self__00243.movingPlatform.movementTransfer == MovementTransferOnJump.PermaTransfer))
					{
						if (_0024self__00243.movingPlatform.newPlatform)
						{
							_0024platform_00242 = _0024self__00243.movingPlatform.activePlatform;
				...
				case 2:
					...
					break;
				case 3:
					if (_0024self__00243.grounded && _0024platform_00242 == _0024self__00243.movingPlatform.activePlatform)
					{
					...
					goto case 4;
				case 4:
					_0024self__00243.movement.velocity = _0024self__00243.movement.velocity - _0024self__00243.movingPlatform.platformVelocity;
					goto IL_0124;
				case 1:
					{
						result = 0;
