...
public class UIColorScheme : MonoBehaviour
{
	...
	public void UpdateColors()
	{
		...
		Button[] componentsInChildren2 = GetComponentsInChildren<Button>(true);
		...
		Toggle[] componentsInChildren3 = GetComponentsInChildren<Toggle>(true);
		...
		Slider[] componentsInChildren4 = GetComponentsInChildren<Slider>(true);
		...
		Text[] componentsInChildren5 = GetComponentsInChildren<Text>(true);
