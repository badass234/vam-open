...
namespace UnityEngine.UI.Extensions
{
	public class ScrollPositionController : UIBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler, IEventSystemHandler
	{
		...
		{
			Vector2 localPoint;
			if (eventData.button == PointerEventData.InputButton.Left && dragging && RectTransformUtility.ScreenPointToLocalPointInRectangle(viewport, eventData.position, eventData.pressEventCamera, out localPoint))
			{
