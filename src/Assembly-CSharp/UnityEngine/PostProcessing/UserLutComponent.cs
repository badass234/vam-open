		...
		public override bool active
		{
			get
			{
				if (base.model != null)
				{
					...
					return base.model.enabled && settings.lut != null && settings.contribution > 0f && settings.lut.height == (int)Mathf.Sqrt(settings.lut.width) && context != null && !context.interrupted;
				}
				return false;
			}
		}
