...
public class MirrorReflection : JSONStorable
{
	...
	public override void InitUI()
	{
		...
		MirrorReflectionUI componentInChildren = UITransform.GetComponentInChildren<MirrorReflectionUI>(true);
	...
	public override void InitUIAlt()
	{
		...
		MirrorReflectionUI componentInChildren = UITransformAlt.GetComponentInChildren<MirrorReflectionUI>(true);
		if (componentInChildren != null)
		{
