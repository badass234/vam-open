...
namespace Obi.Characters.ThirdPerson
{
	...
	public class ThirdPersonCharacter : MonoBehaviour
	{
		...
		private void ScaleCapsuleForCrouching(bool crouch)
		{
			...
			if (Physics.SphereCast(ray, m_Capsule.radius * 0.5f, maxDistance, -5, QueryTriggerInteraction.Ignore))
			{
				m_Crouching = true;
				return;
			}
		...
		{
			RaycastHit hitInfo;
			if (Physics.Raycast(base.transform.position + Vector3.up * 0.1f, Vector3.down, out hitInfo, m_GroundCheckDistance, -5))
			{
