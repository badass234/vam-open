...
public class FollowRotationSelective : MonoBehaviour
{
	...
	private void Start()
	{
		if (mesh != null)
		{
			...
			{
				vertices[i] = bindpose.MultiplyPoint3x4(meshVerts[i]);
			}
	...
	private void SkinMesh()
	{
		...
		for (int i = 0; i < numVertices; i++)
		{
			vertices[i] = localToWorldMatrix.MultiplyPoint3x4(meshVerts[i]);
		}
		drawMesh.vertices = vertices;
	}
	...
	private void DrawMesh()
	{
		if (mesh != null && material != null)
		{
			...
			{
				Graphics.DrawMesh(drawMesh, identity, material, 0, null, i, null, false, false);
			}
		}
	}
