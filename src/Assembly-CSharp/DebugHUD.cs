...
public class DebugHUD : MonoBehaviour
{
	...
	public static void Alert1()
	{
		if (singleton != null)
		{
			...
			{
				singleton.alert1Object.gameObject.SetActive(true);
			}
		}
	}
	...
	public static void Alert2()
	{
		if (singleton != null)
		{
			...
			{
				singleton.alert2Object.gameObject.SetActive(true);
			}
		}
	}
	...
	public static void Alert3()
	{
		if (singleton != null)
		{
			...
			{
				singleton.alert3Object.gameObject.SetActive(true);
			}
		}
	}
	...
	private void Update()
	{
		...
		{
			alert1Object.gameObject.SetActive(false);
		}
		if (alert2Timer >= 0f)
		{
		...
		{
			alert2Object.gameObject.SetActive(false);
		}
		if (alert3Timer >= 0f)
		{
		...
		{
			alert3Object.gameObject.SetActive(false);
		}
	}
}
