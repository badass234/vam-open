...
namespace Leap.Unity
{
	public class LeapTestProvider : LeapProvider
	{
		...
		private void Awake()
		{
			_cachedLeftHand = TestHandFactory.MakeTestHand(true, 0, 0, TestHandFactory.UnitType.UnityUnits);
			_cachedRightHand = TestHandFactory.MakeTestHand(false, 0, 0, TestHandFactory.UnitType.UnityUnits);
		}
