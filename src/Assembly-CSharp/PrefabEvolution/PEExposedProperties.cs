...
namespace PrefabEvolution
{
	...
	public class PEExposedProperties : ISerializationCallbackReceiver
	{
		...
		{
			return Properties.Any((ExposedProperty p) => p.Target == target && p.PropertyPath == propertyPath);
		}

		public void Remove(UnityEngine.Object target, string propertyPath)
		{
			Properties.RemoveAll((ExposedProperty p) => p.Target == target && p.PropertyPath == propertyPath);
		}
